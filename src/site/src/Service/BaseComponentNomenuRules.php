 ...
 * @since  3.4
 */
class BaseComponentNomenuRules implements RulesInterface
{
    /**
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        // vars: [[option] => com_basecomponent, [view] => baseitemlist, [id] => 0]
    ...
    public function build(&$query, &$segments)
    {
        ...
        if (!isset($query['view']) || (isset($query['view']) && $query['view'] !== 'baseitem') || isset($query['format']))
        {
            return;
        }
